...
const contactContent =
  "It looks like you’re trying to reach Daily Saga’s customer service team. To make your life a little easier, please get in contact with Daily Saga’s representatives by reaching out to them directly using the contact :: E-Mail Id : DailySaga@gmail.com";
...
app.get("/", function (req, res) {
    ...
    res.sendFile(__dirname + "/dailysaga.html");
